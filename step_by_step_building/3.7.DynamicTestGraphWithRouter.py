...
# After compiling the graph, add these lines to visualize it
try:
...
#     [HumanMessage(content=r"Analyze the content of this local image in two lines: D:\ML\AgenticAI_Projects\AgenticAI_langgraph\R.jpeg")],
#     initial_model_choice="auto"
# )
